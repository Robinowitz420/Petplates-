...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-surface rounded-xl shadow-2xl border border-surface-highlight w-full max-w-md">
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-surface-highlight">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-lg font-semibold text-gray-300 hover:text-white hover:bg-surface-highlight transition-colors"
          >
            {cancelText}
          </button>
          <button
