                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                        ...
                        {selectedInfluencer.profileUrl && (
                          <button
                            onClick={() => window.open(selectedInfluencer.profileUrl, '_blank')}
                            style={{
                              padding: '0.25rem 0.75rem',
                              backgroundColor: '#3b82f6',
                              color: 'white',
                        ...
                        <button
                          onClick={() => {
                            // Mark as contacted when message is copied
                            if (copyStatus === 'copied') {
                              // In a real app, you'd update the backend
                              alert(`Marked ${selectedInfluencer.displayName} as contacted`);
                            }
                          }}
                          disabled={copyStatus !== 'copied'}
                          style={{
                            padding: '0.25rem 0.75rem',
                            backgroundColor: copyStatus === 'copied' ? '#f59e0b' : '#d1d5db',
                            color: copyStatus === 'copied' ? 'white' : '#6b7280',
                            border: 'none',
                            borderRadius: '0.25rem',
                            cursor: copyStatus === 'copied' ? 'pointer' : 'not-allowed',
                            fontSize: '0.875rem'
                          }}
                        >
                          📝 Mark Contacted
