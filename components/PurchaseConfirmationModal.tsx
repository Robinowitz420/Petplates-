...
export default function PurchaseConfirmationModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-surface rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto border border-surface-highlight">
        {/* Header */}
        <div className="sticky top-0 bg-surface border-b border-surface-highlight p-6 flex items-center justify-between rounded-t-2xl">
          <div>
        ...
        {/* Action Buttons */}
        <div className="sticky bottom-0 bg-surface border-t border-surface-highlight p-6 space-y-3 rounded-b-2xl">
          {!confirmed ? (
            <>
              <button
