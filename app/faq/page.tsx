...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'No. Pet Plates is an educational and planning tool. Always consult your veterinarian when making major dietary changes.',
  },
  {
    ...
    <div className="min-h-screen bg-gray-50 py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-600 mb-12">
          Answers to the most common questions about how Pet Plates works.
        </p>
