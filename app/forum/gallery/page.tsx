      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-surface rounded-lg shadow-md p-6 text-center">
            <ChefHat className="w-8 h-8 mx-auto mb-3 text-orange-400" />
            <div className="text-2xl font-bold text-white mb-1">{communityRecipes.length}</div>
            <div className="text-sm text-white/70">Modified Recipes</div>
          </div>
          <div className="bg-surface rounded-lg shadow-md p-6 text-center">
            ...
            <div className="text-sm text-white/70">Community Contributions</div>
          </div>
          <div className="bg-surface rounded-lg shadow-md p-6 text-center">
          ...
          <div className="bg-surface rounded-lg shadow-md p-6 text-center">
            ...
            <div className="text-sm text-white/70">Helpful Votes</div>
          </div>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                filter === 'all'
                  ...
                  : 'bg-green-900/20 text-orange-300 border border-green-800/40 hover:bg-surface-highlight hover:text-orange-200'
              }`}
            >
              All Meals
            </button>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                  <div className="text-center">
                    <div className="font-semibold text-white">{recipe.totalModifications}</div>
                    <div className="text-white/70">Variations</div>
                  </div>
                  <div className="text-center">
                    <div className="font-semibold text-white">
                      {recipe.modifications.reduce((sum: number, mod: any) => sum + (mod.helpful || 0), 0)}
                    </div>
                    <div className="text-white/70">Helpful</div>
                  </div>
                </div>

                {/* Latest Modification Preview */}
                <div className="mb-4">
                  <h4 className="font-semibold text-orange-300 mb-2">Latest Variation:</h4>
                ...
                <div className="flex gap-2">
                  <Link
                    ...
                    className="flex-1 text-center px-4 py-2 bg-green-800 text-white border-[3px] border-orange-500 text-sm font-medium rounded-lg hover:bg-green-900 transition-colors"
                  >
                    View Recipe
                  </Link>
                  <button className="px-3 py-2 border border-orange-500/60 text-orange-300 text-sm font-medium rounded-lg hover:bg-surface-highlight hover:text-orange-200 transition-colors">
        ...
        {filteredRecipes.length === 0 && (
          <div className="text-center py-12">
            ...
            <Link
              href="/forum"
              className="inline-flex items-center gap-2 px-6 py-3 bg-green-800 text-white border-[3px] border-orange-500 font-semibold rounded-lg hover:bg-green-900 transition-colors"
            >
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-green-800 to-green-900 text-white rounded-lg p-8 mt-12 text-center">
